...
inline State* Game::move(State* parent, short int cann, short int miss, short int boat)
{
	State* child = new State;

	child->leftSide[0] = parent->leftSide[0] + (cann * boat);
	child->leftSide[1] = parent->leftSide[1] + (miss * boat);
	child->rightSide[0] = parent->rightSide[0] - (cann * boat);
	child->rightSide[1] = parent->rightSide[1] - (miss * boat);
